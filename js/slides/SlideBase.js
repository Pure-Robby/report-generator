...
class SlideBase {
    ...
    createLogo() {
        ...
        // Use custom logo path from options, or default to Seacom logo
        img.src = this.options.logoPath || 'assets/seacom-logo.svg';
        img.alt = 'Seacom Logo';
        ...
        img.onerror = () => {
            ...
            placeholder.textContent = 'SEACOM';
    ...
    createFooter(pageNumber) {
        ...
        footerLeft.textContent = this.options.footerText || 'Powered by Pure Survey (PTY) Ltd © 2025. Rights Reserved';
